			            ...
			            <div className="home-contain">
			               <div className="text-white">
			                  ...
			                  <div className="top-margin">
                              	<button type="button" className="btn btn-custom theme-color theme-color">Verified contract</button>
								  <button type="button" className="btn btn-custom theme-color theme-color">View presentation</button>
                           	  </div>
			                  </div>
