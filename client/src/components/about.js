               ...
               <div className="row ">
                  <div className="col-md-5">
                     <div className="about-contain">
                        <div>
                           <h2 className="title">Your ring in <span>Plan 1</span></h2>
                           <p className="caption-about">To exit the plan, press the 'withdraw' button. Remember that you will receive 75% in your wallet.</p>
                           ...
                           <div className="top-margin">
                              <button type="button" className="btn btn-custom theme-color theme-color">Withdraw</button>
                           </div>
                        </div>
                     </div>
                  </div>
